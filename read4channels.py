...
# Modded to measure true RMS current readings: igrowing.
...
if __name__ == "__main__":
    import sys
    print "Poll and print power measure per phase."
    print "Usage: ./poll_power.py [n]\nwhere n is number of polls. Default n=10."
    try:
        n = int(sys.argv[1])
    except:
        n = 10
